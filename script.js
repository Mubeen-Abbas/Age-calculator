...
function calculateAge() {
  ...
  if (user_firstName == "" || user_age == "" || user_lastName == "") {
    ...
    userType = "Teenager";
    substitute_answer.innerHTML = `Hello ${user_firstName} ${user_lastName} , You Are A Teenager 😃😊.You are ${user_age} years and ${userMonth} months old`;
  } else if (user_age >= 19) {
    userType = "Adult";
...
function displayDetails() {
  ...
  userDataAll.forEach((user, index) => {
    ...
    } else if (index === userDataAll.length - 1) {
